...
export default function Develop() {
    ...
    <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-1 lg:py-16 lg:px-6">
        ...
        <div className="font-light text-gray-500 sm:text-lg ">
            <h2 className="mb-4 text-4xl text-center tracking-tight font-extrabold text-gray-900 ">Real State</h2>
            ...
            <h2 className="mb-4 tracking-tight font-extrabold text-gray-900 ">Mensualidades desde $ 4,025 MXN</h2>
        </div>
        <div className="grid grid-cols-1 gap-4 mt-8">
        <img src="./images/merida/render1.jpg" className="ban" />
        <img src="./images/merida/render2.jpg" className="ban" />
        </div>
    </div>
    <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
        
    <div className="font-light text-gray-500 sm:text-lg ">
            <h2 className="my-4  text-3xl tracking-tight font-extrabold text-gray-900  ">Desarrollos en Cancún</h2>
    ...
    <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-1 lg:py-16 lg:px-6">
        ...
        <div className="font-light text-gray-500 sm:text-lg ">
                <h2 className="my-4  text-3xl tracking-tight font-extrabold text-gray-900  ">Propiedades en Ixtapa y Zihuatanajo</h2>
                <p className="mb-4">
Descubre la emocionante oportunidad de inversión en el paraíso costero de Ixtapa y Zihuatanejo, donde el encanto del Pacífico Mexicano se combina con un mercado inmobiliario vibrante. En este idílico destino, te presentamos una cartera diversa que abarca desde casas con vista al mar hasta terrenos y lotes para construir tu proyecto de ensueño.</p>
                <h2 className="mb-4 tracking-tight font-extrabold text-gray-900 ">Casas junto al Mar:</h2>
                <p className="mb-4">Imagina la serenidad de tener una casa frente al océano, donde cada día es una experiencia frente a la brisa marina y las vistas panorámicas. Nuestras propiedades costeras ofrecen la oportunidad de invertir en un estilo de vida relajado y lujoso.</p>
                <h2 className="mb-4 tracking-tight font-extrabold text-gray-900 ">Departamentos Modernos:</h2>
                <p className="mb-4">Para aquellos que buscan comodidad y sofisticación, nuestros departamentos modernos en Ixtapa y Zihuatanejo son la elección perfecta. Con diseño contemporáneo y servicios de primera clase, estas propiedades son ideales tanto para inversión como para vivienda.</p>
                <h2 className="mb-4 tracking-tight font-extrabold text-gray-900 ">Terrenos para tus Sueños:</h2>
                <p className="mb-4">Si tu visión incluye diseñar tu propio refugio, te ofrecemos terrenos estratégicamente ubicados en la zona. Listos para construir, estos terrenos proporcionan la libertad de crear la casa de tus sueños con la playa como telón de fondo.</p>
                <h2 className="mb-4 tracking-tight font-extrabold text-gray-900 ">Lotes con Potencial:</h2>
                <p className="mb-4">Los lotes en Ixtapa y Zihuatanejo representan una oportunidad única para inversionistas visionarios. Ya sea para proyectos residenciales, comerciales o de desarrollo, estos lotes ofrecen un lienzo en blanco para dar vida a tus ideas.</p>
                <h2 className="mb-4 tracking-tight font-extrabold text-gray-900 ">Características Únicas de la Región:</h2>
                <p className="mb-4">Cultura y Gastronomía: Sumérgete en la rica cultura local y disfruta de la auténtica gastronomía mexicana en los encantadores restaurantes de la zona.</p>
                <p className="mb-4">Actividades Acuáticas: Desde deportes acuáticos emocionantes hasta relajantes paseos en barco, la región ofrece una amplia variedad de actividades para todos los gustos.</p>
                <p className="mb-4">Playas Paradisíacas: Descubre playas de arena dorada y aguas cristalinas que hacen de Ixtapa y Zihuatanejo destinos turísticos de renombre mundial.</p>
                <h2 className="mb-4 tracking-tight font-extrabold text-gray-900 ">Oportunidad de Inversión:</h2>
                <p className="mb-4">Con un mercado inmobiliario en constante crecimiento, invertir en propiedades en Ixtapa y Zihuatanejo es más que una compra, es una inversión en calidad de vida y potencial financiero.</p>
                <br/>
                <p className="mb-4">Descubre la magia de esta región y asegura tu inversión en el paraíso costero de Ixtapa y Zihuatanejo. Ya sea para vivir, vacacionar o como proyecto de desarrollo, nuestras propiedades ofrecen un rincón en este paraíso que puedes llamar tuyo.</p>
            </div>
            <div className="grid grid-cols-1 gap-4 mt-8">
            <img src="./images/zihuatanejo.jpeg" className="ban" />
            <img src="./images/zihuatanejo2.jpeg" className="ban" />
