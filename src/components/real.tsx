...
<section className="real">
    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        ...
        <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none  md:text-5xl lg:text-6xl text-white">Real Estate</h1>
	...
	No solo te ofrecemos terrenos con amenidades de primera categoría, sino también un sistema de referidos que te brinda beneficios adicionales. Con certeza jurídica respaldada, garantizamos tu inversión. Además, nuestra promesa de plusvalía asegura que tu patrimonio crezca con el tiempo. </p>
        <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            <a href="/realestate" className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 ">
                Aprender más
